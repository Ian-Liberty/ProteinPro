...
import com.example.proteinpro.databinding.ActivityFavoriteFoodListBinding
...
class ActivityFavoriteFoodList : AppCompatActivity() {
    ...
    private var mBinding:
            ActivityFavoriteFoodListBinding? =null
...
//        setContentView(R.layout.activity_favorite_food_list)
        ...
        mBinding = ActivityFavoriteFoodListBinding.inflate(layoutInflater)
    ...
    private fun initViews() {
        ...
        binding.favoriteRV.adapter = adater
    ...
    private fun initData() {
        ...
        foodretrofitHelper.getMyFavList(token,1, object : FoodRetrofitHelper.MainFoodListCallback{
